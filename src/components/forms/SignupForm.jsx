    ...
    <div className="w-full max-w-md p-8 space-y-3 text-gray-800 rounded-xl bg-gray-50">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-1 text-sm">
          <label htmlFor="username" className="block text-gray-600">Pseudo</label>
          <input
            type="text"
            id="usernameInput"
            className="w-full px-4 py-3 text-gray-800 border-gray-300 rounded-md bg-gray-50 focus:border-cyan-600"
            value={userName}
        ...
        <button type="submit" className="block w-full p-3 text-center rounded-sm text-gray-50 bg-cyan-600">Submit</button>
      </form>
      ...
      <p className="text-xs text-center text-gray-600 sm:px-6">Already have an account?
        <a rel="noopener noreferrer" href="/login" className="text-gray-800 underline">Sign in</a>
      </p>
    </div>
    </div>
  );
